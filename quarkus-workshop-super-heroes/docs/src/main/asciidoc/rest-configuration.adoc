...
----
As we are running our microservice inside a maven container in the Code Ready Workspace environement, we need to make it listening in the `0.0.0.0` IP. For more details check https://quarkus.io/guides/all-config#quarkus-vertx-http_quarkus.http.host
